# UZB-Sector-Package
Data source for Uzbekistan(UZTR/UZSD) Sector Package on Global Nav Generator(GNG)

Full package is available on [files.aero-nav.com](https:/files.aero-nav.com/UZB)
...
We would also really appreciate your help with the already known [issues](https://github.com/orgs/VATSIM-Central-Asia/projects/9)
> [!TIP]
> If you are new to sector development, then check our [wiki](https://github.com/VATSIM-Central-Asia/UZB-Sector-Package/wiki) for more information!
